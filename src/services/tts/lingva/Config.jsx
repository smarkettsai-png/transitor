...
import { DEFAULT_LINGVA_REQUEST_PATH } from '../../lingva/endpoints';
...
export function Config(props) {
    ...
    const [lingvaConfig, setLingvaConfig] = useConfig(
        instanceKey,
        {
            ...
            requestPath: DEFAULT_LINGVA_REQUEST_PATH,
        },
        { sync: false }
    );
        ...
        lingvaConfig !== null && (
            <>
                ...
                <div className={'config-item'}>
                    ...
                    <Input
                        value={lingvaConfig['requestPath'] || DEFAULT_LINGVA_REQUEST_PATH}
                        variant='bordered'
                        className='max-w-[50%]'
                        onValueChange={(value) => {
                            setLingvaConfig({
