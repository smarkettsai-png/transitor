...
export default function General() {
    ...
    const [portableMode, setPortableMode] = useState(null);
    ...
    useEffect(() => {
        invoke('portable_paths').then(({ portable }) => {
                            ...
                            <Dropdown>
                                <DropdownTrigger>
                                    <Button
                                        variant='bordered'
                                        startContent={
                                            <span className={`fi fi-${LanguageFlag[normalizeLocale(appLanguage)]}`} />
                                        }
                                    >
                                        {languageName[normalizeLocale(appLanguage)]}
                                    </Button>
                                </DropdownTrigger>
                                <DropdownMenu
                                    ...
                                    onAction={(key) => {
                                        const language = normalizeLocale(key);
                                ...
                                >
                                    ...
                                    <DropdownItem
                                        key='zh_tw'
                                        startContent={<span className={`fi fi-${LanguageFlag.zh_tw}`} />}
                                    >
                                        繁體中文
                                    </DropdownItem>
                                    <DropdownItem
