...
export default function Translate() {
        ...
        for (const serviceType of serviceTypeList) {
            ...
            try {
                ...
                for (const plugin of plugins) {
                    ...
                    try {
                        const infoPath = await configPath(`plugins/${serviceType}/${pluginName}/info.json`);
                        const infoStr = await readTextFile(infoPath);
    ...
    useEffect(() => {
        ...
        Promise.all([
            ...
            (async () => {
                if (pluginList?.translate?.[TATOEBA_PLUGIN_ID]) {
                    return true;
                }
                try {
